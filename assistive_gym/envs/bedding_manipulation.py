...
class BeddingManipulationEnv(AssistiveEnv):
    ...
    def step(self, action):
        ...
        # print(reward_uncover_target, reward_uncover_nontarget, reward_distance_btw_grasp_release, reward_head_kept_uncovered)
    ...
    def reset(self):
        ...
        # create sphere manipulator for sphere env
    ...
    def generate_points_along_body(self):
        ...
        # self.human.all_body_parts = [self.human.chest]
